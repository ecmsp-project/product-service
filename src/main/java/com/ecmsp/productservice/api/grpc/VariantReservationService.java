...
@GrpcService
public class VariantReservationService extends VariantReservationServiceGrpc.VariantReservationServiceImplBase {
    private static final Logger logger = Logger.getLogger(VariantReservationService.class.getName());

    private final ProductService productService;
    private final VariantService variantService;

    public VariantReservationService(ProductService productService, VariantService variantService) {
